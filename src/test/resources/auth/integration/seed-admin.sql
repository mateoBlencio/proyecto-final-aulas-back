...
SELECT 'admin.test@frc.utn.edu.ar', '$2y$10$o7WlgInnrDPs6RaXEE.P8.u5kv/Z.q6MxDmfAobeVTp50itKh4Yoi', true, false, now(), now()
...
INSERT INTO usuario (correo, password_hash, habilitado, eliminado, creado_en, actualizado_en)
SELECT 'auxiliar.test@frc.utn.edu.ar', '$2y$10$o7WlgInnrDPs6RaXEE.P8.u5kv/Z.q6MxDmfAobeVTp50itKh4Yoi', true, false, now(), now()
...
INSERT INTO usuario (correo, password_hash, habilitado, eliminado, creado_en, actualizado_en)
SELECT 'disabled.test@frc.utn.edu.ar', '$2y$10$o7WlgInnrDPs6RaXEE.P8.u5kv/Z.q6MxDmfAobeVTp50itKh4Yoi', false, false, now(), now()
