...
class OccurrenceTest {
    ...
    private Occurrence occurrence(LocalDate date, LocalTime startTime, Duration duration) {
        UniqueEvent event = AllocationTestData.uniqueEvent(1L, date, startTime, duration);
        return AllocationTestData.occurrence(10L, event, date, OccurrenceStatus.SCHEDULED);
    }
}
