...
class UniqueEventTest {
    ...
    void generaUnaOcurrenciaScheduled() {
        ...
        UniqueEvent event = EventTestData.uniqueEvent(1L, date, LocalTime.of(10, 0), Duration.ofMinutes(60));
    ...
    void exponeStartTimeYEndTime() {
        ...
        UniqueEvent event = EventTestData.uniqueEvent(1L, LocalDate.of(2026, 3, 10), startTime, duration);
    ...
    void getTypeDevuelveUniqueEvent() {
        UniqueEvent event = EventTestData.uniqueEvent(1L, LocalDate.of(2026, 3, 10),
