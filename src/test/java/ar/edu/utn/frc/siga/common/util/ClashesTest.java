...
class ClashesTest {
    ...
    private record Slot(String id, Integer classroomId, LocalDate date, LocalTime startTime, LocalTime endTime)
            implements TimeSpan {
    }
    ...
    void betweenDistintaAulaNoChoca() {
        Slot a = new Slot("a", 5, DAY, LocalTime.of(8, 0), LocalTime.of(9, 30));
        Slot b = new Slot("b", 6, DAY, LocalTime.of(8, 30), LocalTime.of(9, 0));
    ...
    void betweenDistintaFechaNoChoca() {
        Slot a = new Slot("a", 5, DAY, LocalTime.of(8, 0), LocalTime.of(9, 30));
        Slot b = new Slot("b", 5, DAY.plusDays(1), LocalTime.of(8, 0), LocalTime.of(9, 30));
    ...
    void betweenBordeNoSolapa() {
        Slot a = new Slot("a", 5, DAY, LocalTime.of(8, 0), LocalTime.of(9, 30));
        Slot b = new Slot("b", 5, DAY, LocalTime.of(9, 30), LocalTime.of(10, 30));
    ...
    void betweenSinClaveNoChoca() {
        ...
        Slot b = new Slot("b", 5, DAY, LocalTime.of(8, 30), LocalTime.of(9, 0));
    ...
    void withinParUnaSolaVez() {
        Slot a = new Slot("a", 5, DAY, LocalTime.of(8, 0), LocalTime.of(9, 30));
        Slot b = new Slot("b", 5, DAY, LocalTime.of(9, 0), LocalTime.of(10, 0));
        Slot c = new Slot("c", 5, DAY, LocalTime.of(11, 0), LocalTime.of(12, 0));
    ...
    void withinMultiClaveChocaPorFechaCompartida() {
        record MultiDateSlot(String id, Integer classroomId, List<LocalDate> dates, LocalTime startTime, LocalTime endTime)
                implements TimeSpan {
        }
        MultiDateSlot a = new MultiDateSlot("a", 5, List.of(DAY, DAY.plusDays(7)), LocalTime.of(8, 0), LocalTime.of(9, 0));
        MultiDateSlot b = new MultiDateSlot("b", 5, List.of(DAY, DAY.plusDays(7)), LocalTime.of(8, 30), LocalTime.of(9, 30));
