...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(SpaceDomainException.class)
    public ProblemDetail handleSpaceDomain(SpaceDomainException ex) {
        log.warn("Space domain error: {}", ex.getMessage());
        ProblemDetail problem = ProblemDetail.forStatus(HttpStatus.BAD_REQUEST);
        problem.setTitle("Space domain error");
        problem.setDetail(ex.getMessage());
        return problem;
    }
