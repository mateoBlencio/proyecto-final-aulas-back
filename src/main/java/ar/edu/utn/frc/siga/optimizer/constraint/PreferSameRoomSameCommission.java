...
public class PreferSameRoomSameCommission implements OptimizerConstraint {

    static final String NAME = "Preferir misma aula por comision";

    public PreferSameRoomSameCommission() {
    }
    ...
    public Optional<SettingKey> weightKey() {
        return Optional.of(SettingKey.OPTIMIZER_WEIGHT_SAME_COMMISSION_DIFF_ROOM);
    }
}
