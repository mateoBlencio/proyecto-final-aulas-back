...
public interface RefreshTokenRepository extends JpaRepository<RefreshToken, Integer> {
     ...
     */
    // clearAutomatically + flushAutomatically en las tres queries: un @Modifying bulk update
    // no toca el persistence context. Sin clearAutomatically, un find posterior en la misma
    // transacción devolvería la entidad vieja cacheada (revoked=false) en vez de reconsultar
    // la DB. Sin flushAutomatically, clearAutomatically puede tirar cambios pendientes de OTRAS
    // entidades (ej. un User modificado antes de llamar a este método) sin haberlos persistido.
